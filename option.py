...
# Data specificationsn
parser.add_argument('--dir_data', type=str, default='',
                    help='dataset directory')
parser.add_argument('--dir_demo', type=str, default='../test',
                    help='demo image directory')
parser.add_argument('--data_train', type=str, default='DF2K_lmdb',
...
parser.add_argument('--sv_mode', type=int, default=0,
                    help='spatial various')
parser.add_argument('--blur_type', type=str, default='iso_gaussian',
                    help='blur types (iso_gaussian | aniso_gaussian)')
parser.add_argument('--sample_mode', type=str, default='bicubic',
...
## noise
parser.add_argument('--noise_var', action='store_true',
                    help='Enables debug mode')

# Model specifications
parser.add_argument('--model', default='CDSR',
                    help='model name')
...
parser.add_argument('--trans_patch_size', type=int, default=8,
...
parser.add_argument('--circle_scale', type=float, default=30)
parser.add_argument('--freeze_epoch', type=int, default=1000,
                    help='freeze the encoder epoch')
...
parser.add_argument('--use_tb_logger', default=True,
...
if not args.debug:
    ...
    if args.blur_type == 'iso_gaussian':
        dir = './experiment/' + args.save + '_x' + str(int(args.scale[0])) + '_' + args.sample_mode + '_iso'
    elif args.blur_type == 'aniso_gaussian':
        dir = './experiment/' + args.save + '_x' + str(int(args.scale[0])) + '_' + args.sample_mode + '_aniso'
    else:
        dir = './'
